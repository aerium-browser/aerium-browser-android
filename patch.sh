...
# Upstream null-guarded handleKeyboardEvent() itself in 153 (and dropped its
# WebContents parameter), so the guard this used to inject is already in the
# tree - nothing left to substitute.
