...
## 153.0.8010.36 (next release)

**Base**

- Updated to Chromium 153.0.8010.36, by way of Vanadium 153.0.8010.36.0. The
  heading on this section previously said 152.0.7977.84. Nine of our own
  substitutions in patch.sh/theme.sh had drifted with the jump - all fixed;
  see the commit that bumped the submodule for what moved and why.
