...
- [**TablissNG**](https://chromewebstore.google.com/detail/tablissng/dlaogejjiafeobgofajdlkkhjlignalk), a new tab page worth looking at twice, actively maintained. Aerium's own new tab page (Settings → New tab page) now covers a photo background, a clock, a greeting and a quote of the day natively, with nothing ever fetched; reach for this instead if you want live backgrounds, weather or feeds, which is network access this project deliberately doesn't add to a page every tab opens on.
