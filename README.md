...
- **Search that works from the first keystroke.** Startpage is the default engine, with DuckDuckGo, Brave Search, Mojeek, Qwant, Ecosia, degoog and the two DuckDuckGo no-JS variants ready to pick in Settings — and any other engine addable by hand.
